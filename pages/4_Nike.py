...
image = Image.open('Nike-logo1.png')
...
# Convert "InvoiceDate" column to datetime format with the correct format
df["InvoiceDate"] = pd.to_datetime(df["InvoiceDate"], format="%d-%m-%Y")


# Now you can use the .dt accessor to extract month and year
